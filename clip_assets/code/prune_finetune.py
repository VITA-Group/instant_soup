...
if __name__ == '__main__':
    ...
    pruner = Pruner(model.image_encoder)
    pruner.prune_model(0.8)
    ...
    # result = eval_single_dataset(image_encoder, "MNIST", args)
    # print(f"Pretrained : {result}")
    ...
    result = eval_single_dataset(image_encoder, "MNIST", args)
    print(f"Pretrained : {result} at sparsity : {pruner.get_sparsity_ratio()} %")
    print("Done")